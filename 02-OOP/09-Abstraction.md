...
3. [Why Do We Need Abstraction?](#3-why-do-we-need-abstraction)
4. [Abstraction in Java](#4-abstraction-in-java)
5. [What is an Abstract Class?](#5-what-is-an-abstract-class)
6. [What is an Abstract Method?](#6-what-is-an-abstract-method)
7. [Why Do We Need Abstract Methods?](#7-why-do-we-need-abstract-methods)
8. [Basic Abstract Class Example](#8-basic-abstract-class-example)
9. [Can We Create an Object of an Abstract Class?](#9-can-we-create-an-object-of-an-abstract-class)
10. [Why Can an Abstract Class Have a Reference?](#10-why-can-an-abstract-class-have-a-reference)
11. [Can an Abstract Class Have Concrete Methods?](#11-can-an-abstract-class-have-concrete-methods)
12. [Can an Abstract Class Have No Abstract Methods?](#12-can-an-abstract-class-have-no-abstract-methods)
13. [Can an Abstract Class Have Constructors?](#13-can-an-abstract-class-have-constructors)
14. [Why Does an Abstract Class Need a Constructor?](#14-why-does-an-abstract-class-need-a-constructor)
15. [Can an Abstract Class Have Instance Variables?](#15-can-an-abstract-class-have-instance-variables)
16. [Can an Abstract Class Have Static Variables?](#16-can-an-abstract-class-have-static-variables)
17. [Can an Abstract Class Have Final Variables?](#17-can-an-abstract-class-have-final-variables)
18. [Can an Abstract Class Have Static Methods?](#18-can-an-abstract-class-have-static-methods)
19. [Can an Abstract Class Have Final Methods?](#19-can-an-abstract-class-have-final-methods)
20. [Can an Abstract Class Have Private Methods?](#20-can-an-abstract-class-have-private-methods)
21. [Can an Abstract Method Be Private?](#21-can-an-abstract-method-be-private)
22. [Can an Abstract Method Be Final?](#22-can-an-abstract-method-be-final)
23. [Can an Abstract Method Be Static?](#23-can-an-abstract-method-be-static)
24. [Can an Abstract Method Have a Body?](#24-can-an-abstract-method-have-a-body)
25. [Can an Abstract Class Be Final?](#25-can-an-abstract-class-be-final)
26. [Can an Abstract Class Extend Another Abstract Class?](#26-can-an-abstract-class-extend-another-abstract-class)
27. [Can an Abstract Class Extend a Concrete Class?](#27-can-an-abstract-class-extend-a-concrete-class)
28. [Can a Concrete Class Extend an Abstract Class?](#28-can-a-concrete-class-extend-an-abstract-class)
29. [What Happens If a Child Doesn't Implement an Abstract Method?](#29-what-happens-if-a-child-doesnt-implement-an-abstract-method)
30. [Abstraction and Runtime Polymorphism](#30-abstraction-and-runtime-polymorphism)
31. [Abstraction vs Encapsulation](#31-abstraction-vs-encapsulation)
32. [Abstraction vs Inheritance](#32-abstraction-vs-inheritance)
33. [Abstract Class vs Concrete Class](#33-abstract-class-vs-concrete-class)
34. [Abstract Class vs Interface](#34-abstract-class-vs-interface)
35. [When Should We Use an Abstract Class?](#35-when-should-we-use-an-abstract-class)
36. [Real-World Example — Payment System](#36-real-world-example--payment-system)
37. [Real-World Backend Example](#37-real-world-backend-example)
38. [Internal Working of Abstract Classes](#38-internal-working-of-abstract-classes)
39. [Can We Use `super` in an Abstract Class?](#39-can-we-use-super-in-an-abstract-class)
40. [Can an Abstract Class Have a `main()` Method?](#40-can-an-abstract-class-have-a-main-method)
41. [Can We Create an Anonymous Class from an Abstract Class?](#41-can-we-create-an-anonymous-class-from-an-abstract-class)
42. [Can an Abstract Class Implement an Interface?](#42-can-an-abstract-class-implement-an-interface)
43. [Can an Abstract Class Implement Multiple Interfaces?](#43-can-an-abstract-class-implement-multiple-interfaces)
44. [Can an Abstract Class Extend Only One Class?](#44-can-an-abstract-class-extend-only-one-class)
45. [Interview Trap — Abstract Does NOT Mean No Implementation](#45-interview-trap--abstract-does-not-mean-no-implementation)
46. [Interview Trap — Abstract Class Cannot Have Constructors](#46-interview-trap--abstract-class-cannot-have-constructors)
47. [Interview Trap — Abstract Class Cannot Have Objects](#47-interview-trap--abstract-class-cannot-have-objects)
48. [Interview Trap — Abstract Method Can Be Private](#48-interview-trap--abstract-method-can-be-private)
49. [Interview Trap — Abstract Method Can Be Final](#49-interview-trap--abstract-method-can-be-final)
50. [Interview Trap — Abstract Method Can Be Static](#50-interview-trap--abstract-method-can-be-static)
51. [Interview Trap — Abstract Class Must Have Abstract Methods](#51-interview-trap--abstract-class-must-have-abstract-methods)
52. [Interview Trap — Interface and Abstract Class Are the Same](#52-interview-trap--interface-and-abstract-class-are-the-same)
53. [Interview Trap — Abstract Class Gives 100% Abstraction](#53-interview-trap--abstract-class-gives-100-abstraction)
54. [Interview Trap — Abstract Class Is Completely Incomplete](#54-interview-trap--abstract-class-is-completely-incomplete)
55. [Interview Questions & Answers](#55-interview-questions--answers)
56. [Interview Traps — Quick Revision](#56-interview-traps--quick-revision)
57. [Abstraction Mental Model](#57-abstraction-mental-model)
58. [30-Second Interview Answer](#58-30-second-interview-answer)
59. [Top 10 Most Important Interview Questions](#59-top-10-most-important-interview-questions)
60. [Final Cheat Sheet](#60-final-cheat-sheet)
