...
> **An interface is a reference type that defines a contract of behavior which implementing classes agree to provide. It is mainly used for abstraction, loose coupling, polymorphism, and multiple inheritance of type.**
...
- [4. `implements` Keyword](#4-implements-keyword)
- [5. Interface Reference](#5-interface-reference)
- [6. Interface and Runtime Polymorphism](#6-interface-and-runtime-polymorphism)
- [7. Interface as a Contract](#7-interface-is-a-contract)
- [8. Interface Methods](#8-interface-methods)
- [9. Abstract Methods in Interface](#9-abstract-methods-in-interface)
- [10. Interface Abstract Methods Are Public](#10-interface-abstract-methods-are-public)
- [11. Why Must the Implementation Be Public?](#11-why-must-the-implementation-be-public)
- [12. Can an Interface Have Variables?](#12-can-an-interface-have-variables)
- [13. Interface Variables Are Constants](#13-interface-variables-are-constants)
- [14. Does an Interface Have Instance Variables?](#14-does-an-interface-have-instance-variables)
- [15. Interface Fields Must Be Initialized](#15-interface-fields-must-be-initialized)
- [16. Can Interface Fields Be `private`?](#16-can-interface-fields-be-private)
- [17. Multiple Interfaces](#17-multiple-interfaces)
- [18. Multiple Inheritance Through Interfaces](#18-multiple-inheritance-through-interfaces)
- [19. Interface Extending Interface](#19-interface-extending-interface)
- [20. Can an Interface Extend Multiple Interfaces?](#20-can-an-interface-extend-multiple-interfaces)
- [21. Class + Multiple Interfaces](#21-class--multiple-interfaces)
- [22. Interface Cannot Extend a Class](#22-interface-cannot-extend-a-class)
- [23. Class Cannot `implement` a Class](#23-class-cannot-implement-a-class)
- [24. Interface Cannot Be Instantiated](#24-interface-cannot-be-instantiated)
- [25. Can an Interface Have a Constructor?](#25-can-an-interface-have-a-constructor)
- [26. Can an Interface Have a `main()` Method?](#26-can-an-interface-have-a-main-method)
- [27. Default Methods](#27-default-methods)
- [28. Why Were Default Methods Introduced?](#28-why-were-default-methods-introduced)
- [29. Can Default Methods Be Overridden?](#29-can-default-methods-be-overridden)
- [30. Interface Static Methods](#30-interface-static-methods)
- [31. Can Interface Static Methods Be Overridden?](#31-can-interface-static-methods-be-overridden)
- [32. Private Methods in Interfaces](#32-private-methods-in-interfaces)
- [33. Why Were Private Interface Methods Introduced?](#33-why-were-private-interface-methods-introduced)
- [34. Interface Methods — Modern Java Summary](#34-interface-methods--modern-java-summary)
- [35. Interface Method Rules](#35-interface-method-rules)
- [36. Default Method Conflict](#36-default-method-conflict)
- [37. Resolving Default Method Conflict](#37-resolving-default-method-conflict)
- [38. Calling a Specific Interface Default Method](#38-calling-a-specific-interface-default-method)
- [39. Class Method Has Priority Over Interface Default Method](#39-class-method-has-priority-over-interface-default-method)
- [40. Functional Interface](#40-functional-interface)
- [41. `@FunctionalInterface`](#41-functionalinterface)
- [42. Lambda and Functional Interface](#42-lambda-and-functional-interface)
- [43. Marker Interface](#43-marker-interface)
- [44. Interface vs Abstract Class](#44-interface-vs-abstract-class)
- [45. Interface vs Abstract Class — Core Idea](#45-interface-vs-abstract-class--core-idea)
- [46. Can an Interface Have Concrete Methods?](#46-can-an-interface-have-concrete-methods)
- [47. Can an Interface Have a `final` Method?](#47-can-an-interface-have-a-final-method)
- [48. Can an Interface Be `final`?](#48-can-an-interface-be-final)
- [49. Can an Interface Be Abstract?](#49-can-an-interface-be-abstract)
- [50. Can One Interface Be Implemented by Multiple Classes?](#50-can-one-interface-be-implemented-by-multiple-classes)
- [51. Can Multiple Classes Implement the Same Interface?](#51-can-multiple-classes-implement-the-same-interface)
- [52. Can an Interface Extend Multiple Interfaces?](#52-can-an-interface-extend-multiple-interfaces)
- [53. Can a Class Implement Multiple Interfaces?](#53-can-a-class-implement-multiple-interfaces)
- [54. Interface and Loose Coupling](#54-interface-and-loose-coupling)
- [55. Interface and Dependency Injection](#55-interface-and-dependency-injection)
- [56. Interface and Abstraction](#56-interface-and-abstraction)
- [57. Interface and Polymorphism](#57-interface-and-polymorphism)
- [58. Interface and Upcasting](#58-interface-and-upcasting)
- [59. Interface Downcasting](#59-interface-downcasting)
- [60. `instanceof` with Interfaces](#60-instanceof-with-interfaces)
- [61. Nested Interfaces](#61-nested-interfaces)
- [62. Interface Can Contain Nested Types](#62-interface-can-contain-nested-types)
- [63. Interface Inheritance](#63-interface-inheritance)
- [64. Important Difference: `extends` vs `implements`](#64-important-difference-extends-vs-implements)
- [65. Interface Object — Important Interview Trap](#65-interface-object--important-interview-trap)
- [66. Interface Fields — Interview Trap](#66-interface-fields--interview-trap)
- [67. Interface Method — Interview Trap](#67-interface-method--interview-trap)
- [68. Interface Implementation — Interview Trap](#68-interface-implementation--interview-trap)
- [69. Interface Default Method Conflict — Interview Trap](#69-interface-default-method-conflict--interview-trap)
- [70. Class vs Interface Default Method Trap](#70-class-vs-interface-default-method-trap)
- [71. Interface Static Method Trap](#71-interface-static-method-trap)
- [72. Interface vs Concrete Class](#72-interface-vs-concrete-class)
- [73. Interface and Multiple Inheritance Problem](#73-interface-and-multiple-inheritance-problem)
- [74. Interface and `Object` Methods](#74-interface-and-object-methods)
- [75. Real-World Example — QRder](#75-real-world-example--qrder)
- [76. Real-World Backend Example](#76-real-world-backend-example)
- [77. Advantages of Interfaces](#77-advantages-of-interfaces)
- [78. Limitations of Interfaces](#78-limitations-of-interfaces)
- [79. Common Interview Traps](#79-common-interview-traps)
- [80. Interface — Important Interview Questions & Answers](#80-interface--important-interview-questions--answers)
- [81. Interface — Interview Trap Questions](#81-interface--interview-trap-questions)
- [82. Interface — Quick Revision](#82-interface--quick-revision)
- [83. Interface Syntax Cheat Sheet](#83-interface-syntax-cheat-sheet)
- [84. 30-Second Interview Answer](#84-30-second-interview-answer)
- [🔥 Top 10 Most Important Interview Questions](#-top-10-most-important-interview-questions)
